<template>
  <div>
    <v-dialog v-model="isModalShow" max-width="500px">
      ...
      <v-form ref="positionModalForm" lazy-validation class="white pa-5">
...
export default class PositionModal extends Vue {
  ...
  $refs!: {
    positionModalForm: HTMLFormElement;
  };
  ...
  checkPositionExist(value: string, items: string[], message: any) {
